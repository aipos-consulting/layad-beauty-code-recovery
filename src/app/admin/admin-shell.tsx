...
const menuGroups: MenuGroup[] = [
  { label: "INSIGHT", items: [{ label: "Insight Analytics", href: "/admin/insight-analytics" }, { label: "DG Focus", href: "/admin/dg-focus" }] },
  { label: "사용자 관리", items: [{ label: "회원 조회", href: "/admin/members" }] },
