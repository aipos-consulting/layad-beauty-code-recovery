...
type Data = { ok: boolean; message?: string; kpis?: { totalUsers: number; testCompleted: number; manualSelected: number; productRequests: number; requestedProducts: number; completedProducts: number; pendingProducts: number }; sourceRatio?: { test: number; manual: number }; ageStats?: StatRow[]; countryStats?: StatRow[]; regionStats?: StatRow[]; topProducts?: ProductRow[]; recentRequests?: RequestRow[] };
