...
const ANALYSIS_VERSION = "layad-v9-owner-prompt-source-of-truth";
const BEAUTY_CODES = ["OGPV","OGPE","OGCV","OGCE","OMPV","OMPE","OMCV","OMCE","DGPV","DGPE","DGCV","DGCE","DMPV","DMPE","DMCV","DMCE"] as const;

type TraitScores = {
  O:number; D:number; G:number; M:number; P:number; C:number; V:number; E:number;
};
type AiResult = {
