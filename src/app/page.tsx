    ...
    <main className="min-h-screen bg-[#fffdfc] text-[#272322]">
      <header className="border-b border-[#eadfda] bg-white/95">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4 sm:px-8">
          ...
          />
          <p className="text-xs font-semibold tracking-[0.16em] sm:text-sm">LAYAD BEAUTY CODE</p>
        </div>
      </header>
        ...
        <div className="relative mx-auto flex min-h-[650px] max-w-6xl items-center px-5 py-16 sm:px-8 sm:py-20">
          <div className="w-full text-center lg:max-w-4xl">
            ...
            <div className="mx-auto mt-10 grid max-w-xl gap-3">
              <Link
                href="/test"
                className="inline-flex h-14 items-center justify-center gap-6 rounded-full bg-gradient-to-r from-[#d7837e] to-[#cb706f] px-8 text-base font-semibold text-white shadow-[0_12px_30px_rgba(198,105,102,0.25)] transition hover:-translate-y-0.5 hover:shadow-[0_16px_34px_rgba(198,105,102,0.32)]"
              >
                Beauty Code 테스트 시작 <span aria-hidden>→</span>
              </Link>
              <p className="text-xs text-[#756d68]">20문항에 응답해 나의 Beauty Code를 확인합니다.</p>

              <div className="my-1 flex items-center gap-3 text-xs text-[#aa9994]">
                <span className="h-px flex-1 bg-[#eadfda]" />
                또는
                <span className="h-px flex-1 bg-[#eadfda]" />
              </div>
              ...
              <Link
                href="/select-type"
                className="inline-flex h-14 items-center justify-center rounded-full border border-[#d7837e] bg-white px-8 text-base font-semibold text-[#b76766] transition hover:bg-[#fff5f3]"
              >
                내 Beauty Code를 알고 있어요
              </Link>
              <p className="text-xs text-[#756d68]">이미 알고 있는 16유형을 직접 선택합니다.</p>
            </div>
          ...
          <div className="flex flex-col gap-5 sm:flex-row sm:items-start">
            ...
            <div>
              ...
              <p className="mt-3 text-sm leading-6 text-[#5f5753]">
                본 웹사이트의 텍스트, 이미지, 디자인, 프로그램, 분류체계 및 기타 모든 콘텐츠는 LAYAD의 저작권과 지식재산권 보호 대상입니다. LAYAD의 사전 서면 허가 없이 복제, 배포, 전송, 전시, 변형, 2차적 저작물 작성 또는 상업적 이용을 엄격히 금지합니다.
              </p>
              <p className="mt-3 text-sm font-semibold leading-6 text-[#c94f49]">무단 이용이 확인되는 경우 관련 법령에 따라 민사·형사상 책임을 물을 수 있습니다.</p>
            </div>
          </div>
        </div>
      </section>
